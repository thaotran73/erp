...
export class ScreenManagerEditComponent implements OnInit, OnDestroy {
    ...
    async loc_click() {
        ...
        if (retError['number'] == 0) {
            ...
            var params_10 = {eventID: eventID, param: {screen: this.main.screen, title: this.main.title}, postData: {}};
        ...
        if (retError['number'] == 0) {
            ...
            var params_15 = {eventID: eventID, param: {screen: this.main.screen, title: this.main.title}, postData: {}};
        ...
        if (retError['number'] == 0) {
            ...
            var params_20 = {eventID: eventID, param: {screen: this.main.screen, title: this.main.title}, postData: {}};
        ...
        if (retError['number'] == 0) {
            ...
            var params_25 = {eventID: eventID, param: {screen: this.main.screen, title: this.main.title}, postData: {}};
    ...
    async ghi_click() {
        ...
        if (retError['number'] == 0) {
            ...
            var params = {eventID: eventID, param: {}, postData: {screen__dataSelect: this.screen.dataSelect, screen__dataRow: this.screen.dataRow, widget__dataRow: this.widget.dataRow}};
            console.log(params);
