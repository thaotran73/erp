...
@Component({
  selector: 'app-ScreenManagerView',
  templateUrl: './ScreenManagerView.component.html',
  styleUrls: ['./ScreenManagerView.component.css']
})

export class ScreenManagerViewComponent implements OnInit, OnDestroy {
